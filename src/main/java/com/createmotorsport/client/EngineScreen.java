...
@OnlyIn(Dist.CLIENT)
public class EngineScreen extends AbstractContainerScreen<EngineMenu> implements MenuAccess<EngineMenu> {
    private static final ResourceLocation BACKGROUND =
            ResourceLocation.fromNamespaceAndPath(CreateMotorsport.MODID, "textures/gui/container/engine.png");
